...
@__DSOCacheEntry_name.4 = internal constant [35 x i8] c"libSystem.IO.Compression.Native.so\00", align 1
...
@assembly_store_bundled_assemblies = local_unnamed_addr global [304 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 8
