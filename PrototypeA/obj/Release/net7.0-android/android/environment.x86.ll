...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"559f5f31-a528-4251-afe0-79b5a33b5521\00", align 1
...
@__ApplicationConfig_android_package_name.0 = internal constant [31 x i8] c"com.companyname.allplacestudey\00", align 1
...
@__DSOCacheEntry_name.1 = internal constant [50 x i8] c"libSystem.Security.Cryptography.Native.Android.so\00", align 1
@__DSOCacheEntry_name.2 = internal constant [16 x i8] c"libmonodroid.so\00", align 1
@__DSOCacheEntry_name.3 = internal constant [20 x i8] c"libSystem.Native.so\00", align 1
@__DSOCacheEntry_name.4 = internal constant [16 x i8] c"libSkiaSharp.so\00", align 1
@__DSOCacheEntry_name.5 = internal constant [35 x i8] c"libSystem.IO.Compression.Native.so\00", align 1
...
@assembly_store_bundled_assemblies = local_unnamed_addr global [304 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
